...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow) {
    ...
    UINT hr = CreateDXGIFactory1(IID_PPV_ARGS(&factory));
    ...
    while (running) {
        ...
        float clearColor[] = { 0.0f, 0.2f, 0.4f, 1.0f };// Esta si
		command_list->ClearRenderTargetView(rtv_handle, clearColor, 0, nullptr);// Borra el render target osea la ventana
